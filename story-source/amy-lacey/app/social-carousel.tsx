...
const reels = [
 {number:5,posterSecond:2,title:'Podcast Launch Creative',type:'Music + visual storytelling'},
 {number:2,posterSecond:7,title:'Beyond the cauliflower company',type:'Amy’s voice'},
 {number:3,posterSecond:1,title:'Creative brand film',type:'Music + visual storytelling'},
 {number:4,posterSecond:27,title:'Serve the person',type:'Amy’s voice'},
 {number:1,posterSecond:3,title:'Creative brand film',type:'Music + visual storytelling'},
 {number:6,posterSecond:19,title:'A conversation about balance',type:'Amy’s voice'},
];
...
<p className="chapter-label"><span>Activation Content</span></p><h2 id="social-title">Her message, brought to life on screen.</h2>
