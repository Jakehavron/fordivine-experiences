...
<div className="hero-portrait"><picture><source type="image/avif" srcSet="/crowned-stories/amy-lacey/images/amy-portrait-328-v3.avif 328w, /crowned-stories/amy-lacey/images/amy-portrait-420-v3.avif 420w, /crowned-stories/amy-lacey/images/amy-portrait-500-v3.avif 500w, /crowned-stories/amy-lacey/images/amy-portrait-656-v3.avif 656w" sizes="(max-width: 700px) min(238px, calc((100vw - 72px) * .743)), (max-width: 1000px) calc((100vw - 116px) * .2914), min(327px, calc((97.5vw - 120px) * .2914))"/><img src="/crowned-stories/amy-lacey/images/amy-portrait-420-v3.webp" srcSet="/crowned-stories/amy-lacey/images/amy-portrait-328-v3.webp 328w, /crowned-stories/amy-lacey/images/amy-portrait-420-v3.webp 420w, /crowned-stories/amy-lacey/images/amy-portrait-500-v3.webp 500w, /crowned-stories/amy-lacey/images/amy-portrait-656-v3.webp 656w" sizes="(max-width: 700px) min(238px, calc((100vw - 72px) * .743)), (max-width: 1000px) calc((100vw - 116px) * .2914), min(327px, calc((97.5vw - 120px) * .2914))" alt="Amy Lacey in a light blue jacket with her AL monogram" width="1166" height="2000" fetchPriority="high"/></picture></div></div>
