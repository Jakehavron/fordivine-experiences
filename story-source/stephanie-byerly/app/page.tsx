...
<div className="hero-portrait"><img src="/crowned-stories/stephanie-byerly/images/stephanie-portrait-640.webp" srcSet="/crowned-stories/stephanie-byerly/images/stephanie-portrait-320.webp 320w, /crowned-stories/stephanie-byerly/images/stephanie-portrait-480.webp 480w, /crowned-stories/stephanie-byerly/images/stephanie-portrait-640.webp 640w, /crowned-stories/stephanie-byerly/images/stephanie-portrait-880.webp 880w" sizes="(max-width: 700px) min(320px, calc(100vw - 72px)), (max-width: 1200px) 34vw, 440px" alt="Dr. Stephanie Byerly in a burgundy suit with her personal brand monogram" width="923" height="1176" fetchPriority="high"/></div></div>
...
<figure className="brand-showcase"><img src="/crowned-stories/stephanie-byerly/images/stephanie-identity-optimized.webp" alt="UNNUMB identity in gold on a dark navy background" width="1034" height="588" loading="lazy"/><figcaption className="asset-caption">A signature identity connecting her medical background and healing mission.</figcaption></figure>
<div className="application-grid stephanie-identity-gallery"><figure className="brand-showcase"><img src="/crowned-stories/stephanie-byerly/images/stephanie-moodboard-optimized.webp" alt="Stephanie Byerly’s brand mood board in navy, burgundy, cream, and gold" width="1034" height="590" loading="lazy"/><figcaption className="asset-caption">Rich textures and feminine strength shaping the brand’s visual direction.</figcaption></figure><figure className="brand-showcase"><img src="/crowned-stories/stephanie-byerly/images/stephanie-palette-optimized.webp" alt="Stephanie’s brand color palette with parchment, creme, gold, night bordeaux, shadow gray, and onyx" width="1033" height="587" loading="lazy"/><figcaption className="asset-caption">A palette balancing scientific authority, warmth, and gold symbolizing healing.</figcaption></figure></div><figure className="brand-showcase"><img src="/crowned-stories/stephanie-byerly/images/stephanie-brand-marks-optimized.webp" alt="Stephanie Byerly’s decorative brand marks, monograms, seals, and crossed keys" width="1035" height="587" loading="lazy"/><figcaption className="asset-caption">Custom monograms, seals, and keys expressing trust, wisdom, and transformation.</figcaption></figure><figure className="brand-showcase"><img src="/crowned-stories/stephanie-byerly/images/stephanie-brand-mockup-optimized.webp" alt="UNNUMB brand applications across a phone display, tags, and embossed stationery" width="1035" height="587" loading="lazy"/><figcaption className="asset-caption">Her visual identity brought together across digital and printed materials.</figcaption></figure><div className="application-grid stephanie-identity-gallery"><figure className="brand-showcase"><img src="/crowned-stories/stephanie-byerly/images/stephanie-hoodie-optimized.webp" alt="UNNUMB hoodie apparel mockup" width="511" height="590" loading="lazy"/><figcaption className="asset-caption">An apparel concept bringing UNNUMB into everyday life.</figcaption></figure><figure className="brand-showcase"><img src="/crowned-stories/stephanie-byerly/images/stephanie-cap-optimized.webp" alt="UNNUMB cap apparel mockup" width="510" height="590" loading="lazy"/><figcaption className="asset-caption">A signature cap concept extending recognition beyond the screen.</figcaption></figure></div>
<figure className="brand-showcase"><img src="/crowned-stories/stephanie-byerly/images/stephanie-stationery-optimized.webp" alt="Stephanie Byerly’s burgundy envelope with gold lettering and marble-patterned stationery" width="1036" height="592" loading="lazy"/><figcaption className="asset-caption">Gold detailing and rich burgundy carrying her identity into print.</figcaption></figure>
</section>
...
<figure className="brand-showcase" data-asset="digital-hq"><img src="/crowned-stories/stephanie-byerly/images/stephanie-digital-hq-optimized.webp" alt="Stephanie Byerly’s website featuring her portrait, Become UNNUMB headline, and private coaching and speaking invitations" width="1539" height="873" loading="lazy"/><figcaption className="asset-caption">A digital HQ connecting her message, coaching, and speaking opportunities to be easily found by her ideal clientele.</figcaption></figure>
</section>
<SocialCarousel/>
...
<figure className="brand-showcase" data-asset="brand-vault"><picture><source media="(max-width: 700px)" srcSet="/crowned-stories/stephanie-byerly/images/stephanie-brand-vault-mobile-optimized.webp" width="636" height="1285"/><img src="/crowned-stories/stephanie-byerly/images/stephanie-brand-vault-desktop-optimized.webp" alt="Stephanie Byerly’s Brand Vault with her UNNUMB brand bible, mission, mood board, color palette, logos, fonts, brand pillars, mockups, social graphics, professional photos, and content" width="1368" height="620" loading="lazy"/></picture><figcaption className="asset-caption">A look inside her Brand Vault, with organized collections of logos, colors, fonts, brand guidelines, photos, and content ready to use.</figcaption></figure>
</section>
