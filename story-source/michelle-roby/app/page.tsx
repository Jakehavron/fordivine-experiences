...
<section className="hero" id="overview" aria-labelledby="story-title">
  <div className="hero-layout">
    <div className="hero-copy"><p className="eyebrow"><span className="section-number" aria-hidden="true">00</span><span className="section-label">The transformation</span></p><h1 id="story-title"><span className="hero-headline-mobile"><span>From no personal brand or online</span> <span>presence to now getting consulting</span> <span>clients and paid speaking inquiries.</span></span><span className="hero-headline-desktop"><span>From no personal brand or online</span> <span>presence to now getting consulting</span> <span>clients and paid speaking inquiries.</span></span></h1>
