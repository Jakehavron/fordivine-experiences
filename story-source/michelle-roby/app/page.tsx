...
<section className="chapter" id="brand-identity" tabIndex={-1} aria-labelledby="building-title">
  ...
  <figure className="brand-showcase brand-overview" data-asset="brand-bible"><img src="/crowned-stories/michelle-roby/images/michelle-brand-identity-green-gold.png" alt="Michelle Roby’s gold wordmark and monogram on a deep green textured background" width="1069" height="605" loading="lazy"/><figcaption className="asset-caption"><span className="caption-desktop">A signature identity reflecting her experience guiding small business owners.</span><span className="caption-mobile">Her signature brand identity</span></figcaption></figure>
  <div className="application-grid identity-direction-gallery"><figure className="brand-showcase"><img src="/crowned-stories/michelle-roby/images/michelle-moodboard.png" alt="Michelle Roby’s mood board combining deep green textures, gold accents, and black and white imagery" width="1071" height="607" loading="lazy"/><figcaption className="asset-caption"><span className="caption-desktop">Rich greens, warm textures, and personal imagery shaping her brand.</span><span className="caption-mobile">Rich green textures</span></figcaption></figure><figure className="brand-showcase"><img src="/crowned-stories/michelle-roby/images/michelle-color-palette.png" alt="Michelle Roby’s color palette: Parchment, Silver, Gold, Pine Trial, Evergreen, and Rich Black" width="1072" height="608" loading="lazy"/><figcaption className="asset-caption"><span className="caption-desktop">A refined color palette balancing confidence, stability, and approachability.</span><span className="caption-mobile">Her refined palette</span></figcaption></figure></div>
  <figure className="brand-showcase brand-badges"><img src="/crowned-stories/michelle-roby/images/michelle-brand-badges.png" alt="Michelle Roby’s collection of brand badges, monograms, and business guidance seals" width="1072" height="609" loading="lazy"/><figcaption className="asset-caption"><span className="caption-desktop">Custom badges and monograms reinforcing trust, clarity, and business guidance.</span><span className="caption-mobile">Custom badges and monograms</span></figcaption></figure>
  <div className="application-grid">
    <figure className="brand-showcase" data-asset="identity-application-1"><img src="/crowned-stories/michelle-roby/images/michelle-brand-monogram.webp" alt="Michelle Roby’s embossed green wordmark and gold business guidance seal" width="723" height="801" loading="lazy"/><figcaption className="asset-caption"><span className="caption-desktop">Embossed lettering and gold seals bringing her identity into print.</span><span className="caption-mobile">Gold seals in print</span></figcaption></figure>
    <figure className="brand-showcase" data-asset="identity-application-2"><img src="/crowned-stories/michelle-roby/images/michelle-business-cards.webp" alt="Green and cream Michelle Roby business cards displayed on a black tray" width="724" height="803" loading="lazy"/><figcaption className="asset-caption"><span className="caption-desktop">Business card concepts carrying her brand into personal introductions.</span><span className="caption-mobile">Cards that connect</span></figcaption></figure>
    <figure className="brand-showcase" data-asset="identity-application-3"><img src="/crowned-stories/michelle-roby/images/michelle-branded-letter.webp" alt="Michelle Roby’s branded letter inside a deep green envelope with gold lettering" width="726" height="802" loading="lazy"/><figcaption className="asset-caption"><span className="caption-desktop">Branded stationery extending her identity into client correspondence.</span><span className="caption-mobile">Her brand in writing</span></figcaption></figure>
    <figure className="brand-showcase" data-asset="identity-application-4"><img src="/crowned-stories/michelle-roby/images/michelle-brand-mission.webp" alt="Michelle Roby’s mission statement, portrait, and branded stationery in an editorial arrangement" width="722" height="801" loading="lazy"/><figcaption className="asset-caption"><span className="caption-desktop">Her mission, portrait, and stationery presented as one cohesive brand.</span><span className="caption-mobile">Her mission made visible</span></figcaption></figure>
  </div>
</section>
