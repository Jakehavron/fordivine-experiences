...
<section className="hero" id="overview" aria-labelledby="story-title">
  <div className="hero-layout">
    ...
    <figure className="hero-portrait" data-asset="hero-portrait"><img src="/crowned-stories/michelle-roby/images/michelle-portrait-logo-1000.webp" srcSet="/crowned-stories/michelle-roby/images/michelle-portrait-logo-480.webp 480w, /crowned-stories/michelle-roby/images/michelle-portrait-logo-800.webp 800w, /crowned-stories/michelle-roby/images/michelle-portrait-logo-1000.webp 1000w" sizes="(max-width: 700px) min(380px, calc(100vw - 48px)), (max-width: 1000px) 38vw, 500px" alt="Michelle Roby smiling in a black top beside her green MR brand monogram" width="1254" height="1254" fetchPriority="high"/></figure>
  </div>
...
<section className="chapter story-results" id="what-changed" tabIndex={-1} aria-labelledby="results-title">
  ...
  <div className="result-accordions">
    <details className="result-accordion"><summary><svg className="result-check" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" focusable="false"><path d="m4 12 5 5L20 6"/></svg><span className="result-accordion-title">New Consulting Deals</span><svg className="result-chevron" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true"><path d="m6 9 6 6 6-6"/></svg></summary><div className="result-detail"><p>We helped Michelle turn her business experience into a private consulting vertical that brings fulfillment and a new revenue stream.</p><ul><li><svg className="result-bullet-check" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" focusable="false"><path d="m4 12 5 5L20 6"/></svg><span>Closed her first 5-month consulting package</span></li><li><svg className="result-bullet-check" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" focusable="false"><path d="m4 12 5 5L20 6"/></svg><span>Frequent inquiries from warm leads on her website</span></li><li><svg className="result-bullet-check" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" focusable="false"><path d="m4 12 5 5L20 6"/></svg><span>Ability to now promote and expand this offer</span></li></ul></div></details>
    <details className="result-accordion"><summary><svg className="result-check" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" focusable="false"><path d="m4 12 5 5L20 6"/></svg><span className="result-accordion-title">Paid Speaking Inquiries</span><svg className="result-chevron" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true"><path d="m6 9 6 6 6-6"/></svg></summary><div className="result-detail"><p>From not even thinking she can be a professional speaker to now receiving multiple inquiries.</p><ul><li><svg className="result-bullet-check" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" focusable="false"><path d="m4 12 5 5L20 6"/></svg><span>Locked in a speaking opportunity for local business event</span></li><li><svg className="result-bullet-check" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" focusable="false"><path d="m4 12 5 5L20 6"/></svg><span>Received a paid speaking inquiry for a big non-profit event</span></li><li><svg className="result-bullet-check" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" focusable="false"><path d="m4 12 5 5L20 6"/></svg><span>Inbound podcast inquiries to be on different shows</span></li><li><svg className="result-bullet-check" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" focusable="false"><path d="m4 12 5 5L20 6"/></svg><span>Event planners know how to find her for speaking inquiries</span></li></ul></div></details>
    <details className="result-accordion"><summary><svg className="result-check" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" focusable="false"><path d="m4 12 5 5L20 6"/></svg><span className="result-accordion-title">Social Media Growth</span><svg className="result-chevron" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true"><path d="m6 9 6 6 6-6"/></svg></summary><div className="result-detail"><p>From having no social presence or understanding of what to post to now being recognized as a trusted voice in her industry.</p><ul><li><svg className="result-bullet-check" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" focusable="false"><path d="m4 12 5 5L20 6"/></svg><span>Significant increase of engagement on her content</span></li><li><svg className="result-bullet-check" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" focusable="false"><path d="m4 12 5 5L20 6"/></svg><span>Authority is clearly established when people find her page now</span></li><li><svg className="result-bullet-check" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" focusable="false"><path d="m4 12 5 5L20 6"/></svg><span>Her company and team are more bought in seeing her authority online</span></li></ul></div></details>
    <details className="result-accordion"><summary><svg className="result-check" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" focusable="false"><path d="m4 12 5 5L20 6"/></svg><span className="result-accordion-title">More Leads + Job Applications</span><svg className="result-chevron" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true"><path d="m6 9 6 6 6-6"/></svg></summary><div className="result-detail"><p>Michelle finally realizes how a Founder-led brand positively benefits her company as it makes Electric Rays Tanning more visible.</p><ul><li><svg className="result-bullet-check" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" focusable="false"><path d="m4 12 5 5L20 6"/></svg><span>More company leads inquiring from brand recognition</span></li><li><svg className="result-bullet-check" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" focusable="false"><path d="m4 12 5 5L20 6"/></svg><span>Spike in quality job applications because of founder visibility</span></li><li><svg className="result-bullet-check" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" focusable="false"><path d="m4 12 5 5L20 6"/></svg><span>Increased morale and company culture seeing Michelle be visible</span></li></ul></div></details>
  </div>
</section>
