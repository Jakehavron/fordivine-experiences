...
return <>
  ...
  <header className="fd-site-header" data-cs-navigation="custom"><a className="fd-home" href="/discover" aria-label="FORDIVINE home"><img src="/fordivine-logo.webp" alt="FORDIVINE" width="1287" height="201" decoding="async" fetchPriority="high"/></a><nav className="fd-desktop-nav" aria-label="Main navigation"><a href="/discover">Services</a><a href="/crowned-stories">Crowned Stories</a><a href="/discover#book">Inquire</a><a href="/about-us">About Us</a></nav><details className="fd-menu"><summary>Menu<svg aria-hidden="true" width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M3 6h18M3 12h18M3 18h18" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/></svg></summary><nav className="fd-mobile-nav" aria-label="Mobile navigation"><a href="/discover">Services</a><a href="/crowned-stories">Crowned Stories</a><a href="/discover#book">Inquire</a><a href="/about-us">About Us</a></nav></details></header>
<main id="story" className="michelle-story" tabIndex={-1}>
<article>
      <div className="identity-masthead wrap"><p className="client-name">Michelle Roby</p><p className="client-role"><span>Founder of Electric Rays Tanning</span><span aria-hidden="true">⊹</span><span>Small Business Owner</span></p></div>
...
<section className="chapter" id="brand-identity" tabIndex={-1} aria-labelledby="building-title">
  ...
  <figure className="brand-showcase brand-overview" data-asset="brand-bible"><img src="/crowned-stories/michelle-roby/images/michelle-brand-identity-green-gold.png" alt="Michelle Roby’s gold wordmark and monogram on a deep green textured background" width="1069" height="605" loading="lazy"/><figcaption className="asset-caption"><span className="caption-desktop">A signature identity reflecting her experience guiding small business owners.</span><span className="caption-mobile">Her signature brand identity materialized</span></figcaption></figure>
  <div className="application-grid identity-direction-gallery"><figure className="brand-showcase"><img src="/crowned-stories/michelle-roby/images/michelle-moodboard.png" alt="Michelle Roby’s mood board combining deep green textures, gold accents, and black and white imagery" width="1071" height="607" loading="lazy"/><figcaption className="asset-caption"><span className="caption-desktop">Rich greens, warm textures, and personal imagery shaping her brand.</span><span className="caption-mobile">Mood board to guide visual direction</span></figcaption></figure><figure className="brand-showcase"><img src="/crowned-stories/michelle-roby/images/michelle-color-palette.png" alt="Michelle Roby’s color palette: Parchment, Silver, Gold, Pine Trial, Evergreen, and Rich Black" width="1072" height="608" loading="lazy"/><figcaption className="asset-caption"><span className="caption-desktop">A refined color palette balancing confidence, stability, and approachability.</span><span className="caption-mobile">Premium yet balanced color palette</span></figcaption></figure></div>
  <figure className="brand-showcase brand-badges"><img src="/crowned-stories/michelle-roby/images/michelle-brand-badges.png" alt="Michelle Roby’s collection of brand badges, monograms, and business guidance seals" width="1072" height="609" loading="lazy"/><figcaption className="asset-caption"><span className="caption-desktop">Custom badges and monograms reinforcing trust, clarity, and business guidance.</span><span className="caption-mobile">Custom badges and monograms for business assets</span></figcaption></figure>
  <div className="application-grid">
    <figure className="brand-showcase" data-asset="identity-application-1"><img src="/crowned-stories/michelle-roby/images/michelle-brand-monogram.webp" alt="Michelle Roby’s embossed green wordmark and gold business guidance seal" width="723" height="801" loading="lazy"/><figcaption className="asset-caption"><span className="caption-desktop">Embossed lettering and gold seals bringing her identity into print.</span><span className="caption-mobile">Gold details bringing her identity into print</span></figcaption></figure>
    <figure className="brand-showcase" data-asset="identity-application-2"><img src="/crowned-stories/michelle-roby/images/michelle-business-cards.webp" alt="Green and cream Michelle Roby business cards displayed on a black tray" width="724" height="803" loading="lazy"/><figcaption className="asset-caption"><span className="caption-desktop">Business card concepts carrying her brand into personal introductions.</span><span className="caption-mobile">Making her brand memorable at introductions</span></figcaption></figure>
    <figure className="brand-showcase" data-asset="identity-application-3"><img src="/crowned-stories/michelle-roby/images/michelle-branded-letter.webp" alt="Michelle Roby’s branded letter inside a deep green envelope with gold lettering" width="726" height="802" loading="lazy"/><figcaption className="asset-caption"><span className="caption-desktop">Branded stationery extending her identity into client correspondence.</span><span className="caption-mobile">A consistent brand in every client exchange</span></figcaption></figure>
    <figure className="brand-showcase" data-asset="identity-application-4"><img src="/crowned-stories/michelle-roby/images/michelle-brand-mission.webp" alt="Michelle Roby’s mission statement, portrait, and branded stationery in an editorial arrangement" width="722" height="801" loading="lazy"/><figcaption className="asset-caption"><span className="caption-desktop">Her mission, portrait, and stationery presented as one cohesive brand.</span><span className="caption-mobile">Her mission and visuals united as one brand</span></figcaption></figure>
  </div>
</section>
<section className="chapter" id="stepping-into-view" tabIndex={-1} aria-labelledby="activation-title">
  ...
  <figure className="brand-showcase" data-asset="digital-hq"><img src="/crowned-stories/michelle-roby/images/michelle-digital-hq.webp" alt="Michelle Roby’s Digital HQ website, featuring her portrait and the headline Build a business that works for your real life" width="1574" height="948" loading="lazy"/><figcaption className="asset-caption"><span className="caption-desktop">A digital HQ connecting her message, coaching, and speaking opportunities to be easily found by her ideal clientele.</span><span className="caption-mobile">A digital HQ for her expertise to be found</span></figcaption></figure>
...
<section className="chapter story-results" id="what-changed" tabIndex={-1} aria-labelledby="results-title">
  ...
  <p className="intro balanced-intro">After Michelle began sharing her expertise and launched her website, people had a clearer way to discover what she offered. These outcomes made that change tangible.</p>
  <div className="layers-accordion" data-results-layers><div className="layer-slider" aria-hidden="true"/>
<Result index={1} title={"New Consulting Deals"} description={"We helped Michelle turn her business experience into a private consulting vertical that brings fulfillment and a new revenue stream."} points={["Closed her first 5-month consulting package", "Frequent inquiries from warm leads on her website", "Ability to now promote and expand this offer"]}/>
<Result index={2} title={"Paid Speaking Inquiries"} description={"From not even thinking she can be a professional speaker to now receiving multiple inquiries."} points={["Locked in a speaking opportunity for local business event", "Received a paid speaking inquiry for a big non-profit event", "Inbound podcast inquiries to be on different shows", "Event planners know how to find her for speaking inquiries"]}/>
<Result index={3} title={"Social Media Growth"} description={"From having no social presence or understanding of what to post to now being recognized as a trusted voice in her industry."} points={["Significant increase of engagement on her content", "Authority is clearly established when people find her page now", "Her company and team are more bought in seeing her authority online"]}/>
<Result index={4} title={"More Leads + Job Applications"} description={"Michelle finally realizes how a Founder-led brand positively benefits her company as it makes Electric Rays Tanning more visible."} points={["More company leads inquiring from brand recognition", "Spike in quality job applications because of founder visibility", "Increased morale and company culture seeing Michelle be visible"]}/>
</div>
</section>
<section className="chapter lesson" id="the-lesson" tabIndex={-1} aria-labelledby="lesson-title">
  ...
  <figure className="brand-showcase testimonial-media"><img src="/crowned-stories/michelle-roby/images/michelle-media-kit.webp" alt="Michelle Roby’s media kit featuring her portrait and her leadership of Electric Rays Tanning" width="1440" height="809" loading="lazy"/><figcaption className="asset-caption"><span className="caption-desktop">Her expertise and signature message packaged for speaking and podcast opportunities.</span><span className="caption-mobile">Cover image of media kit for speaking inquiries</span></figcaption></figure>
</section>
