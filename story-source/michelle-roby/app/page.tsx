...
<section className="chapter" id="starting-point" tabIndex={-1} aria-labelledby="before-title">
  ...
  <ul className="problem-list">
    ...
    <li><strong>Trust depended heavily on knowing her personally.</strong> As her business expanded, she wanted prospective employees, clients, and partners to understand who was leading it.</li>
...
<section className="chapter" id="brand-identity" tabIndex={-1} aria-labelledby="building-title">
  ...
  <h2 id="building-title">A brand that felt like Michelle.</h2>
...
<section className="chapter story-results" id="what-changed" tabIndex={-1} aria-labelledby="results-title">
  ...
  <h2 id="results-title">New opportunities became real conversations.</h2>
