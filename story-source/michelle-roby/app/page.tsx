...
<section className="chapter story-results" id="what-changed" tabIndex={-1} aria-labelledby="results-title">
  ...
  <div className="result-accordions">
    <details className="result-accordion"><summary><svg className="result-check" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" focusable="false"><path d="m4 12 5 5L20 6"/></svg><span className="result-accordion-title">New Consulting Deals</span><svg className="result-chevron" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true"><path d="m6 9 6 6 6-6"/></svg></summary><div className="result-detail"><p>Michelle turned her business experience into consulting work, including a five-month engagement that began through her website.</p><ul><li>An inquiry through her website</li><li>A five-month consulting engagement</li><li>Support with team and sales growth</li></ul></div></details>
    <details className="result-accordion"><summary><svg className="result-check" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" focusable="false"><path d="m4 12 5 5L20 6"/></svg><span className="result-accordion-title">Paid Speaking Inquiries</span><svg className="result-chevron" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true"><path d="m6 9 6 6 6-6"/></svg></summary><div className="result-detail"><p>Michelle received speaking inquiries, including a paid opportunity at a local business event within weeks of launch.</p><ul><li>Speaking inquiries after launch</li><li>A paid speaking opportunity</li><li>A local business audience</li></ul></div></details>
    <details className="result-accordion"><summary><svg className="result-check" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" focusable="false"><path d="m4 12 5 5L20 6"/></svg><span className="result-accordion-title">Social Media Growth</span><svg className="result-chevron" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true"><path d="m6 9 6 6 6-6"/></svg></summary><div className="result-detail"><p>Michelle saw increased social engagement as she began sharing her business experience through a clear personal brand.</p><ul><li>More engagement with her content</li><li>Business experience brought online</li><li>A clear, consistent public message</li></ul></div></details>
    <details className="result-accordion"><summary><svg className="result-check" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" focusable="false"><path d="m4 12 5 5L20 6"/></svg><span className="result-accordion-title">More Leads + Job Applications</span><svg className="result-chevron" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true"><path d="m6 9 6 6 6-6"/></svg></summary><div className="result-detail"><p>Michelle saw more company leads and job applications as her personal brand made the founder behind Electric Rays more visible.</p><ul><li>More company leads</li><li>More job applications</li><li>A visible founder behind the company</li></ul></div></details>
  </div>
</section>
