...
<section className="chapter story-results" id="what-changed" tabIndex={-1} aria-labelledby="results-title">
  ...
  <div className="result-accordions">
    <details className="result-accordion"><summary><svg className="result-check" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" focusable="false"><path d="m4 12 5 5L20 6"/></svg><span className="result-accordion-title">New Consulting Deals</span><svg className="result-chevron" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true"><path d="m6 9 6 6 6-6"/></svg></summary><div className="result-detail"><p>We helped Michelle turn her business experience into a private consulting vertical that brings fulfillment and a new revenue stream.</p><ul><li>Closed her first 5-month consulting package</li><li>Frequent inquiries from warm leads on her website</li><li>Ability to now promote and expand this offer</li></ul></div></details>
    <details className="result-accordion"><summary><svg className="result-check" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" focusable="false"><path d="m4 12 5 5L20 6"/></svg><span className="result-accordion-title">Paid Speaking Inquiries</span><svg className="result-chevron" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true"><path d="m6 9 6 6 6-6"/></svg></summary><div className="result-detail"><p>From not even thinking she can be a professional speaker to now receiving multiple inquiries.</p><ul><li>Locked in a speaking opportunity for local business event</li><li>Received a paid speaking inquiry for a big non-profit event</li><li>Inbound podcast inquiries to be on different shows</li><li>Event planners know how to find her for speaking inquiries</li></ul></div></details>
    <details className="result-accordion"><summary><svg className="result-check" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" focusable="false"><path d="m4 12 5 5L20 6"/></svg><span className="result-accordion-title">Social Media Growth</span><svg className="result-chevron" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true"><path d="m6 9 6 6 6-6"/></svg></summary><div className="result-detail"><p>From having no social presence or understanding of what to post to now being recognized as a trusted voice in her industry.</p><ul><li>Significant increase of engagement on her content</li><li>Authority is clearly established when people find her page now</li><li>Her company and team are more bought in seeing her authority online</li></ul></div></details>
    <details className="result-accordion"><summary><svg className="result-check" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" focusable="false"><path d="m4 12 5 5L20 6"/></svg><span className="result-accordion-title">More Leads + Job Applications</span><svg className="result-chevron" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true"><path d="m6 9 6 6 6-6"/></svg></summary><div className="result-detail"><p>Michelle finally realizes how a Founder-led brand positively benefits her company as it makes Electric Rays Tanning more visible.</p><ul><li>More company leads inquiring from brand recognition</li><li>Spike in quality job applications because of founder visibility</li><li>Increased morale and company culture seeing Michelle be visible</li></ul></div></details>
  </div>
</section>
