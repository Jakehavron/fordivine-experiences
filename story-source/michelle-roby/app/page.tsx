...
return <>
  ...
  <header className="header"><a href="https://www.fordivine.com/discover" className="wordmark" aria-label="FORDIVINE home"><img src="/crowned-stories/michelle-roby/images/fordivine-logo.webp" alt="FORDIVINE" width="1287" height="201"/></a><nav className="site-nav" aria-label="Main navigation"><a href="https://www.fordivine.com/discover">Services</a><a href="https://www.fordivine.com/crowned-stories">Crowned Stories</a><a href="/discover#book">Inquire</a><a href="https://www.fordivine.com/about-us">About Us</a></nav><details className="mobile-menu"><summary style={{ gap: 10 }}>Menu<svg aria-hidden="true" width="20" height="20" viewBox="0 0 24 24" fill="none" style={{ flexShrink: 0 }}><path d="M3 6h18M3 12h18M3 18h18" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/></svg></summary><nav aria-label="Mobile navigation"><a href="https://www.fordivine.com/discover">Services</a><a href="https://www.fordivine.com/crowned-stories">Crowned Stories</a><a href="/discover#book">Inquire</a><a href="https://www.fordivine.com/about-us">About Us</a></nav></details></header>
