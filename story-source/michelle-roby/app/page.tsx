...
<section className="chapter" id="brand-identity" tabIndex={-1} aria-labelledby="building-title">
  ...
  <div className="application-grid identity-direction-gallery"><figure className="brand-showcase"><img src="/crowned-stories/michelle-roby/images/michelle-moodboard.png" alt="Michelle Roby’s mood board combining deep green textures, gold accents, and black and white imagery" width="1071" height="607" loading="lazy"/></figure><figure className="brand-showcase"><img src="/crowned-stories/michelle-roby/images/michelle-color-palette.png" alt="Michelle Roby’s color palette: Parchment, Silver, Gold, Pine Trial, Evergreen, and Rich Black" width="1072" height="608" loading="lazy"/></figure></div>
  <figure className="brand-showcase brand-badges"><img src="/crowned-stories/michelle-roby/images/michelle-brand-badges.png" alt="Michelle Roby’s collection of brand badges, monograms, and business guidance seals" width="1072" height="609" loading="lazy"/></figure>
  <div className="application-grid">
