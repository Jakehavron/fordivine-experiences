...
export default function SocialCarousel() {
  ...
  return <section className="chapter social-carousel" id="social-content" aria-labelledby="social-title" aria-roledescription="carousel">
    ...
    <div className="social-carousel-heading"><div className="social-controls"><button type="button" aria-label="Previous Instagram posts" aria-controls="social-posts" disabled={position.start} onClick={()=>move(-1)}><Arrow direction="left"/></button><button type="button" aria-label="Next Instagram posts" aria-controls="social-posts" disabled={position.end} onClick={()=>move(1)}><Arrow direction="right"/></button></div></div>
