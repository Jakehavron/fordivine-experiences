export default function ProfileComparison() {
  ...
  return <figure className="profile-comparison" aria-label="Michelle’s Instagram before and after">
    ...
    <figcaption id="profile-compare-help"><span className="caption-desktop">Drag left or right to see the transformation.</span><span className="caption-mobile">Slide to compare profiles</span></figcaption>
  </figure>;
}
